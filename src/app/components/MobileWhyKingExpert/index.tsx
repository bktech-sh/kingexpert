  ...
  return (
    <div className="flex justify-center w-screen gap-4 py-20">
      <div className="flex gap-1 flex-col bg-mainOrange rounded-2xl w-20 h-20 justify-center items-center">
        <h2 className="h-fit color text-white font-bold text-xl">20+</h2>
      ...
      <div className="flex gap-1 flex-col bg-mainOrange rounded-2xl w-20 h-20 justify-center items-center">
        <h2 className="h-fit color text-white font-bold text-xl">50+</h2>
      ...
      <div className="flex gap-1 flex-col bg-mainOrange rounded-2xl w-20 h-20 justify-center items-center">
        <h2 className="h-fit color text-white font-bold text-xl">500+</h2>
